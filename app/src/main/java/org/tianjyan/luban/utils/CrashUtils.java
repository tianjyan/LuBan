...
public final class CrashUtils {
    ...
    static {
        ...
        UNCAUGHT_EXCEPTION_HANDLER = new UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread t, final Throwable e) {
                ...
                String fileName = Utils.getFileTime() + ".txt";
    ...
    public static boolean init(@NonNull final File crashDir) {
        return init(crashDir.getAbsolutePath() + Utils.FILE_SEP);
    }
    ...
    public static boolean init(final String crashDir) {
        if (isSpace(crashDir)) {
            ...
            dir = crashDir.endsWith(Utils.FILE_SEP) ? dir : dir + Utils.FILE_SEP;
        }
        if (mInitialized) return true;
        defaultDir = Utils.getCacheDir() + Utils.FILE_SEP + "Crash" + Utils.FILE_SEP;
